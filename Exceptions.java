...
///////////////////////////////
// Excepción para controlar que el precio del traje no supere el precio máximo
class PrecioMaximoException extends Exception {

    public PrecioMaximoException(String message) {
        super(message);
    }
}
